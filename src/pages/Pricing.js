...
class Pricing extends React.Component {
    render() {
     ...
     <div className= "pricing-body">
      ...
      <br/>
      $19.99: Let us walk through some of the basics of Gluten Free Living. This is a 15 minute consult will briefly guide through the do's and dont's of eating gluten free. The main  
      outcome of this appointment is to answer all your pertinent questions. <br/>
      <br/>
